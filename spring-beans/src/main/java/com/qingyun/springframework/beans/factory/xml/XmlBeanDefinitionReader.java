...
import com.qingyun.springframework.beans.annotation.ClassPathBeanDefinitionScanner;
...
/**
 * @description： 当定义bean的资源resource是Xml类型的文件时，解析Xml文件并生成Bean的定义信息，然后将其注册
 * @author: 張青云
